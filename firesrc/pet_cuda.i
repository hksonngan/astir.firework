...
import_array();
%}
void kernel_pet3D_LMOSEM_cuda(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1,
...
void kernel_pet3D_LMOSEM_att_cuda(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1,
								  unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1,
								  unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1,
								  float* IN_ARRAY3, int DIM1, int DIM2, int DIM3,
								  float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3,
