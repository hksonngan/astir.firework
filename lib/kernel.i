...
void kernel_draw_2D_lines_DDA_fixed(float* INPLACE_ARRAY2, int DIM1, int DIM2, int* IN_ARRAY1, int DIM1, int* IN_ARRAY1, int DIM1, int* IN_ARRAY1, int DIM1, int* IN_ARRAY1, int DIM1);
...
void kernel_draw_2D_lines_WALA(float* INPLACE_ARRAY2, int DIM1, int DIM2, int* IN_ARRAY1, int DIM1, int* IN_ARRAY1, int DIM1, int* IN_ARRAY1, int DIM1, int* IN_ARRAY1, int DIM1);
...
void kernel_pet3D_IM_SRM_DDA(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, int wim);
void kernel_pet3D_IM_SRM_DDA_fixed(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, int wim);
void kernel_pet3D_IM_SRM_BLA(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, int wim);
...
void kernel_pet3D_IM_SRM_ELL_DDA_ON_iter(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, float* IN_ARRAY3, int DIM1, int DIM2, int DIM3, float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, int wim, int ndata);
void kernel_pet3D_IM_SRM_ELL_DDA_fixed_ON_iter(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, float* IN_ARRAY3, int DIM1, int DIM2, int DIM3, float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, int wim, int ndata);
void kernel_pet3D_IM_SRM_ELL_DDA_fixed_ON_ATT_iter(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, float* IN_ARRAY3, int DIM1, int DIM2, int DIM3, float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, float* IN_ARRAY3, int DIM1, int DIM2, int DIM3, int wim, int ndata);
void kernel_pet3D_IM_SRM_COO_DDA_ON_iter(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, float* IN_ARRAY3, int DIM1, int DIM2, int DIM3, float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, int wim);
void kernel_pet3D_IM_SRM_RAW_DDA_ON_iter(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, float* IN_ARRAY3, int DIM1, int DIM2, int DIM3, float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, int wim);
...
void kernel_pet3D_IM_ATT_SRM_COO_ON_SIDDON_iter(float* IN_ARRAY1, int DIM1, float* IN_ARRAY1, int DIM1, float* IN_ARRAY1, int DIM1, float* IN_ARRAY1, int DIM1, float* IN_ARRAY1, int DIM1, float* IN_ARRAY1, int DIM1, float* IN_ARRAY1, int DIM1, float* INPLACE_ARRAY1, int DIM1, float* IN_ARRAY1, int DIM1, int wim, int dim, int border);
...
void kernel_draw_3D_line_BLA(float* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, int x1, int y1, int z1, int x2, int y2, int z2, float val);
...
void kernel_pet3D_IM_SRM_DDA_cuda(unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, unsigned short int* IN_ARRAY1, int DIM1, int* INPLACE_ARRAY3, int DIM1, int DIM2, int DIM3, int wim, int ID);
